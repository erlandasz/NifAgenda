...
@section('content')
    ...
    <div class='row timetable__list'>
        ...
        <div class='col'>
            ...
            <div class="card timetable-card timetable__card-prL">
                <div class="card-body">
        ...
        <div class='col'>
            <div class="card timetable-card timetable__card-prR">
                <div class="card-body">
    ...
    <div class='row timetable__list'>
        ...
        <div class='col'>
            <a class='' href='/presenting-companies/33'>
            <div class="card timetable-card timetable__card-prL">
                <div class="card-body">
        ...
        <div class='col'>
            ...
            <div class="card row presenters__track-c timetable-card timetable__card-prR">
                <div class="card-body">
                    <h5 class="card-title">13:30</h5>
                    <h6 class="card-subtitle mb-2 text-muted">Room Heritage</h6>
