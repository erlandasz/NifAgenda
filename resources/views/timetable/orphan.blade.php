<div id='accordion'>
    <div class="card timetable-card timetable__card-panel timetable_lightPinkSub" data-toggle='collapse' data-target='#collapseOrphan' aria-expanded="true" aria-controls="collapseOrphan">
        <div class="card-body">
            <h5 class="card-title">14:10</h5>
            <h6 class="card-subtitle mb-2 text-muted">Room Commandants</h6>
            <p class="card-text"><b>Rare & Orphan Diseases Panel</b></p>
        </div>
    </div>
    <div id="collapseOrphan" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
        <div class="card-body">
